        ...
        {testimonial.images && testimonial.images.length > 0 && (
          <div className="flex gap-2 mt-4">
            {testimonial.images.slice(0, 3).map((image) => (
              <div key={image} className="relative w-16 h-16 rounded-lg overflow-hidden">
                <Image
                  src={image}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Real experiences from real travelers who discovered the magic of Rishikesh and Haridwar
          ...
          <div className="flex items-center justify-center gap-8 mb-8">
            ...
            <div className="text-center">
              <div className="font-bold text-2xl text-gray-900 mb-2">{totalReviews}+</div>
              <p className="text-sm text-gray-600">Happy Travelers</p>
            </div>
            <div className="w-px h-12 bg-gray-300"></div>
            <div className="text-center">
              <div className="font-bold text-2xl text-gray-900 mb-2">{verifiedCount}</div>
            ...
            {Array.from({ length: maxIndex + 1 }).map((_, i) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  i === currentIndex ? 'bg-orange-600 scale-125' : 'bg-gray-300 hover:bg-gray-400'
                }`}
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Join thousands of satisfied travelers and experience the magic of sacred India with
